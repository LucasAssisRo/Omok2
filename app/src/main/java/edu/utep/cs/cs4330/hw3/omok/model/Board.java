...
public class Board {
     ...
     */
    public int east(int x, int y, char player){
    ...
    public int west(int x, int y, char player){
        if(x>BOARDSIZE-1 || y>BOARDSIZE-1 || x<0 || y<0)
            return 0;
        if(board[x][y]==player){
    ...
    public int south(int x, int y, char player){
        if(x>BOARDSIZE-1 || y>BOARDSIZE-1 || x<0 || y<0)
            return 0;
        if(board[x][y]==player){
    ...
    public int north(int x, int y, char player){
        if(x>BOARDSIZE-1 || y>BOARDSIZE-1 || x<0 || y<0)
            return 0;
        if(board[x][y]==player){
    ...
    public int northWest(int x, int y, char player){
        if(x>BOARDSIZE-1 || y>BOARDSIZE-1 || x<0 || y<0)
            return 0;
        if(board[x][y]==player){
    ...
    public int northEast(int x, int y, char player){
    ...
    public int southWest(int x, int y, char player){
        if(x>BOARDSIZE-1 || y>BOARDSIZE-1 || x<0 || y<0)
            return 0;
        if(board[x][y]==player){
    ...
    public int southEast(int x, int y, char player){
        if(x>BOARDSIZE-1 || y>BOARDSIZE-1 || x<0 || y<0)
            return 0;
        if(board[x][y]==player){
